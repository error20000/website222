...
@API(info="预约", entity={Share.class})
public class ShareController extends BaseController<Share> {
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="active", type="int", isNull=0,  info="活动"),
				@ParamsInfo(name="type", type="int", isNull=0,  info="分类"),
				@ParamsInfo(name="ip", type="String", isNull=0,  info="ip"),
				@ParamsInfo(name="other", type="String", isNull=0,  info="参与人"),
				@ParamsInfo(name="info", type="String", isNull=0,  info="附加信息"),
				@ParamsInfo(name="info1", type="String", isNull=0,  info="附加信息1"),
				@ParamsInfo(name="info2", type="String", isNull=0,  info="附加信息2"),
				@ParamsInfo(name="info3", type="String", isNull=0,  info="附加信息3"),
				@ParamsInfo(name="info4", type="String", isNull=0,  info="附加信息4"),
		}, 
		response={
