...
@API(info="", entity={EmailLogs.class})
public class EmailLogsController extends BaseController<EmailLogs> {

	@Autowired
	private EmailLogsService service;
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="email", type="String", isNull=0,  info="邮箱"),
				...
				@ParamsInfo(name="msg", type="String", isNull=0,  info="返回信息"),
		}, 
		response={
