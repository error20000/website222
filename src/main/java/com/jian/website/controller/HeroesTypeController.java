...
@Controller
@RequestMapping("/api/heroesType")
@API(info="", entity={HeroesType.class})
public class HeroesTypeController extends BaseController<HeroesType> {

	@Autowired
	private HeroesTypeService service;
