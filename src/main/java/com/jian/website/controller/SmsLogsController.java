...
@API(info="", entity={SmsLogs.class})
public class SmsLogsController extends BaseController<SmsLogs> {

	@Autowired
	private SmsLogsService service;
	...
	@API(name="新增", 
		...
		request={
				...
				@ParamsInfo(name="content", type="String", isNull=0,  info="发送内容"),
