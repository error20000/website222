...
@Controller
@RequestMapping("/api/heroesAttrTpSel")
@API(info="角色配置的属性的选项表", entity={HeroesAttrTpSel.class})
public class HeroesAttrTpSelController extends BaseController<HeroesAttrTpSel> {

	@Autowired
	private HeroesAttrTpSelService service;
