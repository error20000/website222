...
@Controller
@RequestMapping("/api/activeConfigAttr")
@API(info="活动配置的属性表", entity={ActiveConfigAttr.class})
public class ActiveConfigAttrController extends BaseController<ActiveConfigAttr> {

	@Autowired
	private ActiveConfigAttrService service;
	...
	@API(name="新增", 
		...
		request={
				...
				@ParamsInfo(name="config", type="int", isNull=0,  info="配置"),
