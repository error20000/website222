...
@Controller
@RequestMapping("/api/contactConfig")
@API(info="", entity={ContactConfig.class})
public class ContactConfigController extends BaseController<ContactConfig> {

	@Autowired
	private ContactConfigService service;
