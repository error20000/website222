...
@Controller
@RequestMapping("/api/bespeakType")
@API(info="", entity={BespeakType.class})
public class BespeakTypeController extends BaseController<BespeakType> {

	@Autowired
	private BespeakTypeService service;
