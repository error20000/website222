...
@Controller
@RequestMapping("/api/heroesAttrTp")
@API(info="角色配置的属性模版表", entity={HeroesAttrTp.class})
public class HeroesAttrTpController extends BaseController<HeroesAttrTp> {

	@Autowired
	private HeroesAttrTpService service;
