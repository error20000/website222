...
@Controller
@RequestMapping("/api/recommendType")
@API(info="", entity={RecommendType.class})
public class RecommendTypeController extends BaseController<RecommendType> {

	@Autowired
	private RecommendTypeService service;
