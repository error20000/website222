...
@API(info="", entity={SystemLogs.class})
public class SystemLogsController extends BaseController<SystemLogs> {
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="type", type="String", isNull=0,  info="分类"),
				@ParamsInfo(name="user", type="int", isNull=0,  info="用户"),
				@ParamsInfo(name="ip", type="String", isNull=0,  info="ip"),
				@ParamsInfo(name="uri", type="String", isNull=0,  info="按钮"),
				@ParamsInfo(name="params", type="String", isNull=0,  info="参数"),
				@ParamsInfo(name="before", type="String", isNull=0,  info="更新前"),
				@ParamsInfo(name="after", type="String", isNull=0,  info="更新后"),
		}, 
		response={
