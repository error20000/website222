...
@Controller
@RequestMapping("/api/activeAttr")
@API(info="活动属性表", entity={ActiveAttr.class})
public class ActiveAttrController extends BaseController<ActiveAttr> {

	@Autowired
	private ActiveAttrService service;
