...
@Controller
@RequestMapping("/api/playerLogs")
@API(info="", entity={PlayerLogs.class})
public class PlayerLogsController extends BaseController<PlayerLogs> {

	@Autowired
	private PlayerLogsService service;
	...
	@API(name="新增", 
		...
		request={
				...
				@ParamsInfo(name="other", type="String", isNull=0,  info="参与者"),
		}, 
		response={
	...
	@API(name="分页查询", 
		...
		request={
				...
				@ParamsInfo(name="type", type="int", isNull=0,  info="分类"),
				@ParamsInfo(name="other", type="String", isNull=0,  info="参与者"),
				@ParamsInfo(name="info", type="String", isNull=0,  info=""),
