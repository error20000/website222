...
@Controller
@RequestMapping("/api/resourcesType")
@API(info="", entity={ResourcesType.class})
public class ResourcesTypeController extends BaseController<ResourcesType> {
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="parent", type="int", isNull=0,  info="父级"),
