...
@Controller
@RequestMapping("/api/heroesAttr")
@API(info="角色配置的属性模版表", entity={HeroesAttr.class})
public class HeroesAttrController extends BaseController<HeroesAttr> {

	@Autowired
	private HeroesAttrService service;
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="hero", type="int", isNull=0,  info="角色"),
