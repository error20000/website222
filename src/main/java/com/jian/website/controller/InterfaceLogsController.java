...
@Controller
@RequestMapping("/api/interfaceLogs")
@API(info="礼包日志", entity={InterfaceLogs.class})
public class InterfaceLogsController extends BaseController<InterfaceLogs> {

	@Autowired
	private InterfaceLogsService service;
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="ifs", type="int", isNull=0,  info="接口"),
				@ParamsInfo(name="params", type="String", isNull=0,  info="参数"),
				@ParamsInfo(name="status", type="int", isNull=0,  info="状态   0：失败 ， 1 ： 成功"),
				@ParamsInfo(name="ifsRes", type="String", isNull=0,  info="接口返回信息"),
				@ParamsInfo(name="reCount", type="int", isNull=0,  info="重发次数"),
				@ParamsInfo(name="reUser", type="String", isNull=0,  info="重发人"),
				@ParamsInfo(name="reDate", type="String", isNull=0,  info="重发时间"),
				@ParamsInfo(name="reSend", type="String", isNull=0,  info="重发结果"),
