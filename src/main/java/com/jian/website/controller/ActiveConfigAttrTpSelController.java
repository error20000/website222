...
@Controller
@RequestMapping("/api/activeConfigAttrTpSel")
@API(info="活动配置的属性的选项表", entity={ActiveConfigAttrTpSel.class})
public class ActiveConfigAttrTpSelController extends BaseController<ActiveConfigAttrTpSel> {

	@Autowired
	private ActiveConfigAttrTpSelService service;
	...
	@API(name="新增", 
		...
		request={
				...
				@ParamsInfo(name="temp", type="int", isNull=0,  info="模版"),
