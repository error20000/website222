...
public class ServerController extends BaseController<Server> {
	...
	@API(name="新增", 
		...
		request={
				//add request
				@ParamsInfo(name="serverId", type="String", isNull=1,  info="服务器ID"),
				@ParamsInfo(name="name", type="String", isNull=0,  info="名称"),
				@ParamsInfo(name="url", type="String", isNull=0,  info="地址"),
				@ParamsInfo(name="key", type="String", isNull=0,  info="密钥"),
	...
	@API(name="分页查询", 
		...
		request={
				...
				@ParamsInfo(name="serverId", type="String", isNull=0,  info="服务器ID"),
				@ParamsInfo(name="name", type="String", isNull=0,  info="名称"),
				@ParamsInfo(name="url", type="String", isNull=0,  info="地址"),
				@ParamsInfo(name="key", type="String", isNull=0,  info="密钥"),
				@ParamsInfo(name="status", type="int", isNull=0,  info="状态   0：禁用，1：启用"),
