...
public class Strategy  extends Base<Strategy> {
	...
	@Excel(name="简介  文章、作者类", sort=13, length="", isNull=1 )
	private String adesc;
	@Excel(name="加精  0--否，1--是", sort=14, value="0", length="4", isNull=1 )
	private int highlight;
	@Excel(name="是否推到首页  0--否，1--是", sort=15, value="0", length="4", isNull=1 )
	private int home;
